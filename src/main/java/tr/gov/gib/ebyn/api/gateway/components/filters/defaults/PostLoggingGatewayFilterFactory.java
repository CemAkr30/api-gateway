...
public class PostLoggingGatewayFilterFactory
    extends AbstractLoggingGatewayFilterFactory<PostLoggingGatewayFilterFactory.Config> {

    public PostLoggingGatewayFilterFactory(ILogService logService) {
        super(PostLoggingGatewayFilterFactory.Config.class, logService);
    }
    ...
    public GatewayFilter apply(Config config) {
        ...
        }, OrderEnum.POST_LOGGING_FILTER.ordinal());
    }
